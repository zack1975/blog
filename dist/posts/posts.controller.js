...
const update_blogpost_dto_1 = require("./dto/update-blogpost.dto");
...
let PostsController = class PostsController {
    ...
    async updateBlogPost(blogPost, id) {
...
], PostsController.prototype, "listBlogPosts", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], PostsController.prototype, "getBlogPostById", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", Promise)
], PostsController.prototype, "createBlogPost", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_blogpost_dto_1.UpdateBlogPostDto, String]),
    __metadata("design:returntype", Promise)
], PostsController.prototype, "updateBlogPost", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PostsController.prototype, "deleteBlogPost", null);
exports.PostsController = PostsController = __decorate([
    (0, common_1.Controller)('posts'),
    __metadata("design:paramtypes", [posts_service_1.BlogPostsService])
], PostsController);
